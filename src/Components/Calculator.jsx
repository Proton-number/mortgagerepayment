...
function Calculator() {
  ...
  console.log(theme);
  return (
   <Stack direction="column" sx={{justifyContent:"center", padding:"20px", width:{lg:"50%"}}} spacing={4}>
     ...
     <label>Mortgage Amount</label>
      <TextField        
          InputProps={{
            ...
            marginLeft: "-13px",height:"42%"}}>£</InputAdornment>,
          }}
      />
     </Stack>
    ...
    <Button variant='contained' sx={{textTransform:'none', backgroundColor:"hsl(59, 71%, 55%)", color:"hsl(141, 25%, 16%)", padding:"15px", borderRadius:"25px", width:{lg:"50%"}, "&:hover":{backgroundColor:"hsl(59, 71%, 55%)", color:"hsl(141, 25%, 16%)"}}}>
      <Stack spacing={3} direction="row"  sx={{  alignItems:"center"}}>
